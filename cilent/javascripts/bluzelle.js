...
$('#query_bt').click(() => {
    console.log("verify")
    bluzelle.has($('#file_name-query').text()).then(fileName => {
...
},{"bluzelle":6}],5:[function(require,module,exports){
/*
 * base64-arraybuffer
...
},{"./base64convert":7,"./communication":8}],7:[function(require,module,exports){
(function (global){
...
},{"base64-arraybuffer":5,"buffer":2}],8:[function(require,module,exports){
...
},{"isomorphic-ws":9}],9:[function(require,module,exports){
(function (global){
